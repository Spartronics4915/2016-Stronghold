 ...
 *
 */
public class AutoLowbarVision extends CommandGroup {
    //autonomous program that uses the vision to drive under the low bar
    
    public  AutoLowbarVision() {
        // Add Commands here:
        ...
        addSequential(new AutoAimControlCommand(true, false));
